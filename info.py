...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+AOjcHxBEowBhYTRl')  # Support group link (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '1002756381177'))  # Notification of sent to your channel
