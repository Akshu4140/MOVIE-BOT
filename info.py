...
API_ID = int(environ.get('API_ID', '24800275')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '3ca19bfd185ec57ff99133563f5fd32f')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/z1ox34.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/k07uvy.jpg'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '5097249261')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '1001811270779')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+8gqLjCFGlEMxYTk1')  # Support group link (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/k07uvy.jpg')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kalgudeakshada:kalgudeakshada@cluster0.sqg3tlf.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "kalgudeakshada") # Database name (default: cluster)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002866064533')) #Verification Channel Id 
...
SHORTENER_API = environ.get("SHORTENER_API", "b78ee1546e857385cbe44e34e3a24fc8fa71347a") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "b78ee1546e857385cbe44e34e3a24fc8fa71347a")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "b78ee1546e857385cbe44e34e3a24fc8fa71347a")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "arolinks.comn") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TgHub4u') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kindness617') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/darkcloud617') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'MOVIEHUNTZONE'))
MULTI_CLIENT = False
